...
def createTracker3NodeMI():
    ...
    loadTrackingDataTab.addLoadTrackingDataUI(tracker3Node,
                                              "trackerNodeMI.loadTracker3TrackingDataFromFilePopup(nuke.thisNode())",
                                              "trackerNodeMI.loadTracker3TrackingDataFromClipboard(nuke.thisNode())")
    ...
    tracker3Node['label'].setValue('MochaImport+')
    return tracker3Node
...
def createTracker4NodeMI():
    ...
    loadTrackingDataTab.addLoadTrackingDataUI(tracker4Node,
                                              "trackerNodeMI.loadTracker4TrackingDataFromFilePopup(nuke.thisNode())",
                                              "trackerNodeMI.loadTracker4TrackingDataFromClipboard(nuke.thisNode())")
    
    for _ in range(0,4):
        tracker4Node['add_track'].execute()
        
    tracker4Node['label'].setValue('MochaImport+')
