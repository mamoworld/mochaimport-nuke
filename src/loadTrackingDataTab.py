...
def addLoadTrackingDataUI(trackerNode,commandLoadFromFile,commandLoadFromClipboard):
    trackerNode.addKnob(nuke.Tab_Knob('mochaImport','MochaImport+') )
    ...
    loadDataFromFileKnob.setTooltip("import mocha corner pin data from a file\n\nrequired format: Nuke Corner Pin (*.nk)");
    ...
    loadDataFromClipboardKnob.setTooltip("import mocha corner pin data from the clipboard\n\nrequired format: Nuke Corner Pin (*.nk)");
